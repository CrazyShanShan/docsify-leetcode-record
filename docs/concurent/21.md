...
Java SDK并发包里提供的原子类很丰富，我们可以将它们分为五个类别：
...
五个类别提供的方法基本上是相似的，并且每个类别都有若干原子类，你可以通过下面的原子类组成概览图来获得一个全局的印象。下面我们详细解读这五个类别。

![image-20210304235534961](images/image-20210304235534961.png)
